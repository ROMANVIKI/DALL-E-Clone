    ...
    <section className=' max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
          ...
          DALL-E AI and share them ith the Community
        </p>     
      </div>
      <form className='mt-16 max-2-3xl' onSubmit={handleSubmit} action="">
        ...
        <div className='mt-10'>
              ...
              Once you have created the image you ant, you can share it with others in the Community
              </p>
              <button 
